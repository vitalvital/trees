...
void factor(struct Number *N)
{
	...
	limit = (long long)sqrt((double)number);

	while(Primes[i] <= limit + 2)
	{
			...
			for(power = 0; power < N.powers[i]; power++)
				...
				else
				{
					...
					return;            				/* DONE (V#1#): Write a function for an alternative way of calculating 
				                perfectness without trigering overflow 1 */
				}

			subproduct = (subproduct -1)/(N.factors[i] - 1);
			if(_UI64_MAX/product > subproduct)	//overflow protection
				product *= subproduct;
			else
			{
				printf("\nOverflow 2");
...
void destiny(void)
{
	...
	if(strlen(N.ch) > 19)
	{
		...
		while(N.a != 1)
		{
				...
				if(strlen(N.ch) > 18)
 	              {
                		printf("\nThe number is getting too big. Can no longer gurantee accuracy\n");
                		return;
               	  }
				product = 1;
                if(_UI64_MAX/N.factors[N.lastPrimeIndex] > N.factors[N.lastPrimeIndex])
                {
    				for( i = 0; i <= N.lastPrimeIndex; i++)
    				{
    					subproduct = N.factors[i];
                                                                                            ...
                                                                                            for(p5 = 1; p5 <= N.powers[i5]; p5++)
                                                                                            {
                                                                                                    ...
                                                                                                    for(i6 = i5 + 1; i6 <= N.lastPrimeIndex; i6++)
                                                                                                    {
                                                                                                           ...
                                                                                                           for(p6 = 1; p6 <= N.powers[i6]; p6++)
                                                                                                           {
                                                                                                                  ...
                                                                                                                  sum += factor1 * factor2 * factor3 * factor4 * factor5 * factor6;
                                                                                                           }
                                                                                                    }
                                                                                            }
                                                                                    }
...
void test(void)         
{
    ...
    int i1, i2, i3, i4, i5, i6, i7, i8, i9, p1, p2, p3, p4, p5, p6, p7, p8, p9;
                                                                                                           ...
                                                                                                           for(p6 = 1; p6 <= N.powers[i6]; p6++)
                                                                                                           {
                                                                                                                  ...
                                                                                                                  for(i7 = i6 + 1; i7 <= N.lastPrimeIndex; i7++)
                                                                                                                  {
                                                                                                                         ...
                                                                                                                         for(p7 = 1; p7 <= N.powers[i7]; p7++)
                                                                                                                         {
                                                                                                                                ...
                                                                                                                                sum += factor1 * factor2 * factor3 * factor4 * factor5 * factor6 * factor7;
                                                                                                                                for(i8 = i7 + 1; i8 <= N.lastPrimeIndex; i8++)
                                                                                                                                {
                                                                                                                                       ...
                                                                                                                                       for(p8 = 1; p8 <= N.powers[i8]; p8++)
                                                                                                                                       {
                                                                                                                                              ...
                                                                                                                                              sum += factor1 * factor2 * factor3 * factor4 * factor5 * factor6 * factor7 * factor8;
                                                                                                                                       }
                                                                                                                                }
                                                                                                                         }
                                                                                                                  }
		...
		for(k = 0; k < cycle; k++)
		{
              ...
              factor(&N);
				...
				if(N.a == 1)
				       break;
				product = 1;
				/* TODO (V#1#): test time for different methods of calcualting 
				                perfectness */
